...
class Grid:
    def __init__(self, code, language, font_size=14, cell_width=20, cell_height=20, background_color=(30, 30, 30)):
        self.code = code
...
grid = Grid(code, language, font_size=12, cell_width=15, cell_height=15, background_color=(30, 30, 30))
